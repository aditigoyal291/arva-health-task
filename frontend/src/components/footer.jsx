...
function Footer() {
  return (
    <section className="relative overflow-hidden bg-slate-200/30 mt-5 py-8">
      <div className="container relative z-10 mx-auto px-4">
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center">
             <img src="/images/logo.png" alt=""  className="h-[50px] w-[50px]"/>
                <span className="ml-4 text-lg font-bold">Arva Caffe</span>
              </div>
            </a>
          </div>
          <div className="w-auto p-8">
